  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: CupertinoListTile(
        ...
        subtitle: Text('${device.username}@${device.hostname}:${device.port}'),
        trailing: Row(
...
class _AddDeviceScreenState extends State<AddDeviceScreen> {
  ...
  Future<void> _addDevice() async {
    ...
    if (name.isEmpty || hostname.isEmpty || username.isEmpty) {
      showCupertinoDialog(
        context: context,
        builder: (context) => CupertinoAlertDialog(
      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'Note: SSH key authentication must be configured on the server running the REST API.',
              style: TextStyle(
                fontSize: 12,
                color: CupertinoColors.systemGrey,
              ),
