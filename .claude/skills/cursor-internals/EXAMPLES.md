...
**For database operation examples, see the [cursor-db skill](../cursor-db/EXAMPLES.md).**
...
def cursor_agent_workflow():
    ...
    For database handling details, see cursor-db skill EXAMPLES.md
    """
...
- **Database operations:** [cursor-db skill](../cursor-db/EXAMPLES.md)
